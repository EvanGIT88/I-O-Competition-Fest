<?php
include("C:/xampp-8.1/htdocs/Product Manager/app_view/Register Page/register-page.html");
include("C:/xampp-8.1/htdocs/Product Manager/app_controller/register-controller.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
